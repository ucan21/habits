...
self.addEventListener('fetch',e=>{if(!e.request.url.includes('/habits/'))return;e.respondWith(fetch(e.request,{cache:'no-store'}).catch(()=>caches.match(e.target)));});
